    ...
    <script src="<?php echo base_url('assets/plugin/bootstrap-5.1.3-dist/js/bootstrap.min.js')?> "></script>
    <script src="<?php echo base_url('assets/plugin/fontawesome/all.min.js')?> "> </script>
    <script src="<?php echo base_url('assets/plugin/jquery/jquery-3.6.0.min.js') ?>"> </script>
